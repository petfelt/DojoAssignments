...
export class UploaderComponent implements OnInit {
  ...
  constructor(
    ...
    this.responses = [];
    this.title = 'Untitled';
    this.caption = 'An untitled work.';
    this.page = 'photo';
    this.gallery = 'Default Gallery';
  }
  ...
  ngOnInit(): void {
    ...
    this.uploader.onBuildItemForm = (fileItem: any, form: FormData): any => {
      ...
      let tags = 'mattfelt';
      if (this.title) {
        form.append('context', `name=${this.title}|caption=${this.caption}`);
        tags = `mattfelt,${this.page},${this.gallery}`;
      }
